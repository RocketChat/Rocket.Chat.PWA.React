...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      "@components": resolve("../src/components/app-components/"),
			"@utils": resolve("../src/components/util-components/"),
			"@actions": resolve("../src/store/actions"),
			"@epics": resolve("../src/store/epics"),
  ...
  plugins: [
    ...
    new webpack.NamedChunksPlugin(chunk => {
      ...
      return chunk.mapModules(m => path.relative(m.context, m.request))
        .join('_');
    }),
